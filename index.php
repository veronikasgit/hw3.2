<!-- 
	Плиморфизм - принцип ООП, позволяющий использовать разные типы данных.

	Наследование – принцип ООП, позволяющий копировать свойства и методы базовых классов, и дающий возможность их переопределять и расширять
 -->

<!-- 
	В абстрактном классе может быть не реализован один или больше методов.

	В интерфейсе же ни один метод не реализован, все они публичные и нет переменных класса 
-->
